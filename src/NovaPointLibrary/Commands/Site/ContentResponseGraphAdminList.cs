...
{
    public class ContentResponseGraphAdminList
    {
    ...
    public class GraphAdminListSite
    {
    ...
    public class Fields
    {
        ...
        public int FileViewedOrEdited { get; set; }
        ...
        public string SiteCreationSource { get; set; }
        ...
        public string StorageUsedPercentage { get; set; }
