...
namespace NovaPointLibrary.Solutions.Automation
{
    public class CopyFilesAuto
    {
        ...
        private CopyFilesAuto(NPLogger logger, Commands.Authentication.AppInfo appInfo, CopyFilesAutoParameters parameters)
        {
            _param = parameters;
            _logger = logger;
            _appInfo = appInfo;
        ...
        public static async Task RunAsync(CopyFilesAutoParameters parameters, Action<LogInfo> uiAddLog, CancellationTokenSource cancelTokenSource)
        {
            ...
            NPLogger logger = new(uiAddLog, "CopyFilesAuto", parameters);
            //return;
            try
            {
        ...
        private async Task RunScriptAsync()
        {
            ...
            //await ProcessListItems(oSourceWeb, oDestinationWeb, listFilesToCopy, destinationServerRelativeUrl);
            ...
            {
                await ProcessListItemsTEST(oSourceWeb, oDestinationWeb, listItem, destinationServerRelativeUrl);
                progress.ProgressUpdateReport();
            });

            //await Parallel.ForEachAsync(listFilesToCopy, par, )
        ...
        private async Task ProcessListItemsTEST(Web sourceWeb, Web destinationWeb, ListItem oListItem, string destinationServerRelativeUrl)
        {
            _appInfo.IsCancelled();
